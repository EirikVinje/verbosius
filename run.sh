...
python verbosius/xai_transformer/stage_transformer.py --dataset $dataset --input_traindata $input_traindata --input_testdata $input_testdata --model_output $model_output --save_model $save_model --chunkdist_n $chunkdist_n 
