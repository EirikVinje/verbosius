...
python verbosius/xai_transformer/stage_transformer.py --dataset $dataset --input_traindata $input_traindata --model_output $model_output --chunkdist_n $chunkdist_n 
