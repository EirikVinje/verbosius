from src import generate_trainingdata
import unittest


class TestGenerateTrainingData(unittest.TestCase):

    def test_allign_tokens_labels_weights(self):
        ...
        self.assertEqual(alligned_tokens, expected_tokens)
        self.assertEqual(alligned_weights, expected_weights)
        self.assertEqual(alligned_labels, expected_labels)
