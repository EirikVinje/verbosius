...
if __name__ == "__main__":
    ...
    study = optuna.create_study(study_name="hprun__cs8000_cn5", direction="maximize", storage=f"sqlite:////home/{user}/projects/verbosius/sqlite3.db", load_if_exists=True)
