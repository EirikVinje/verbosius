...
import tokenclassifier.tokenclass_funcs as tf


def stage_tokenclassifier(dataset : str, train_val_input : str, test_input : str, model_output : str, chunkdist_n : int):
    ...
    tf.transformer_pipeline_tokenclassifier(output_dir=model_path, 
...
if __name__ == "__main__":
    ...
    stage_tokenclassifier(args.dataset, args.input_traindata, args.input_testdata, args.model_output, args.chunkdist_n)
